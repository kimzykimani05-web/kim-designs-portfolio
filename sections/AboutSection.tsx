         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
           ...
           >
             <div className="relative">
               <div className="w-full aspect-square max-w-lg mx-auto lg:mx-0 rounded-2xl sm:rounded-3xl border border-white/10 flex items-center justify-center shadow-2xl shadow-black/40 overflow-hidden">
                 <Image
