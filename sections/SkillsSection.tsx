...
const SkillsSection = () => {
   return (
     <section id="skills" className="relative py-20 sm:py-24 lg:py-32 bg-dark-secondary overflow-hidden">
       <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 lg:gap-8">
           {skills.map((skill, idx) => (
             ...
             >
               <div className="glass-card rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8 card-hover h-full flex flex-col">
                 <div className="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-5">
                   ...
                   <div className="flex-grow">
                     <div className="flex items-center justify-between mb-1">
                       <h3 className="text-lg sm:text-xl font-bold text-light-primary">{skill.name}</h3>
                       <span className="text-xs sm:text-sm font-semibold text-light-muted">{skill.level}%</span>
                     </div>
